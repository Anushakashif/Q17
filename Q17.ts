// 17. Shrinking Guest: You just found out that your new dinner table won't arrive in time for the dinner, and you 
...
let guestArr: string[] = ["Yusra", "Ali", "Iqra", "Hunain"]
